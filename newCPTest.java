   ...
   /**try
    ...
    for (int j=0; j<5; j++){
	    ...
	    for (int i=0; i<=2; i++){
	    	...
	    	//System.out.println("  ...O." + pointb);
	    	pointb.convertStorageToPolar();
	    	//System.out.println("  ...P." + pointb);
	    	
	    	
	    	pointb.convertStorageToCartesian();
	    	//System.out.println("  ...C." + pointb);
	    ...
	    for (int i=0; i<=20000000; i++){
	    	...
	    	double x = (Math.random()*10.0);
	    	double y = (Math.random()*10.0);
	    	point6 = new PointCP6('C',x,y);
	    	point6.convertStorageToCartesian();
	    	pointc = new PointCP6('P',x,y);
	    	pointc.convertStorageToPolar();
	    	
	    	point6.getDistance(new PointCP6('C',0.0,0.0));
	    	pointc.getDistance(new PointCP6('P',0.0,0.0));
